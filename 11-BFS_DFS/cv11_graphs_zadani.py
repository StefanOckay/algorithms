...
from cv01_queue_zadani import *
from cv01_stack_zadani import *
...
def check_bfs(graph, start, parent, distance):
    bfs(graph, start)
...
def check_dfs(graph, start, parent, discovery_time, finishing_time):
    dfs(graph, start)
